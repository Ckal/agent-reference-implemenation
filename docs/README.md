...
- URL: https://huggingface.co/spaces/Chris4K/agent-reference-implemenation
- SDK: streamlit
...
1. **Private Monorepo** (development)
   - Location: `apps/huggingface/agent-reference-implemenation/`
   - All development happens here
   - Contains secrets and private configuration

2. **Public GitHub Repository**
   - URL: https://github.com/Ckal/agent-reference-implemenation
